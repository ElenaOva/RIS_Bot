            ...
            if message.text == '/start':
                ...
                bot.send_message(message.chat.id,
                                 text='{0.first_name}, хорошо!\nНапиши сюда свои мысли и идеи, что бы ты хотел '
                                      'улучшить, что бы хотел предложить нового для развития ролевого движения или для '
                                      'развития этого канала ☺️\nАдмин прочитает и, если его заинтересует твоя идея, '
                                      'то он может связаться с тобой для уточнения подробностей, если ты указал свой '
